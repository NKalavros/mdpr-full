...
if __name__ == "__main__":
    ...
    my_parser.add_argument('-f',metavar='f',type=str,nargs='?',help="File to dock",default ="0.fasta")
    ...
    num_threads = 1 #Need only 1 sequences
    ...
    rna_tertiary_structure_prediction(firstfile) #Predict tertiary structure
    rna_tertiary_structure_refinement(firstfile) #Refine tertiary structure
    secondary_structure = secondary_from_tertiary(firstfile) #This takes too little to need pooling, get secondary structure from tertiary
    dot_bracket_to_cns(secondary_structure,firstfile) #Create ten separate rna-dna_restraints.def files, one for each
